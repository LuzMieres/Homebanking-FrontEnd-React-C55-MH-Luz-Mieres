  ...
  return (
    <div className="flex flex-col justify-between items-center w-full sm:w-auto mr-10 h-[120vh]">
      <section className={`section nav h-[114vh] mb-[20%] flex flex-col justify-between items-center p-4 ${showNav ? 'show' : ''}`}>
        <div>
          <Link to='/'><img className='ml-12 w-28 hsvg-28 rounded-full border-white border-2 cursor-pointer hover:scale-110 transition duration-500 ease-in-out hover:shadow hover:shadow-blue-900 hover:shadow-2xl' src="../src/assets/images/bank-icon.svg" alt="bank icon" /></Link>
                ...
                <li className='w-full '>
                  <summary className="group flex items-center justify-between rounded-lg px-4 py-2 text-white hover:bg-blue-600 ">
                    <div className="flex items-center gap-2 ">
                      <svg className='w-6 h-6' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="3000" height="3000" viewBox="0 0 3000 3000">
