...
function Nav() {
  return (
    ...
    <ul className="space-y-1 flex flex-col justify-between items-center h-screen p-5">
      <img className='w-20 h-20' src="./src/assets/images/bank-icon.svg" alt="bank icon" />
      <div>
        <li>
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            <summary
              className="group flex items-center justify-between rounded-lg px-4 py-2 text-orange-500 hover:bg-gray-100 hover:text-gray-700"
            >
              <div className="flex items-center gap-2">
                ...
                <Link to="accounts" className="text-lg text-orange-500 font-medium w-4/5"> Accounts </Link>
              </div>
            ...
            <ul className="mt-2 space-y-1 px-4">
              <li>
                <Link to="accounts"
                  className="group flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-orange-500 hover:bg-gray-100 hover:text-gray-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="size-5 opacity-75"
                    fill="none"
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <Link to="cards" className="text-lg text-orange-500 font-medium"> Cards </Link>
              </div>
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <Link to="transactions" className="text-lg text-orange-500 font-medium"> Transactions </Link>
              </div>
          ...
          <details className="group [&_summary::-webkit-details-marker]:hidden">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <Link to="loans" className="text-lg text-orange-500 font-medium"> Loans </Link>
              </div>
      ...
      <div>
        <li>
          <form action="#">
            <button
              type="submit"
              className="w-full rounded-lg px-4 py-2 text-lg font-medium text-orange-500 [text-align:_inherit] hover:bg-gray-100 hover:text-gray-700"
            >
              <svg xmlns="http://www.w3.org/2000/svg"
                height="24px"
                viewBox="0 -960 960 960"
